...
class OperacieNadJazykmi2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi2, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi2, OperacieNadJazykmi3::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi2, OperacieNadJazykmi1::class.java))
            finish()
        }
    }
