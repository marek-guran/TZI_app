...
class AbecedaSlovoJazyk6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk6, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk6, AbecedaSlovoJazyk7::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk6, AbecedaSlovoJazyk5::class.java))
            finish()
        }
    }
