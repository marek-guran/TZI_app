...
class OperacieNadJazykmi5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi5, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi5, OperacieNadJazykmi6::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi5, OperacieNadJazykmi4::class.java))
            finish()
        }
    }
