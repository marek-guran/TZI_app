...
class AbecedaSlovoJazyk2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk2, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk2, AbecedaSlovoJazyk3::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk2, AbecedaSlovoJazyk1::class.java))
            finish()
        }
    }
