...
public class KonecnyAutomat2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat2.this, MainActivity.class));
                finish();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat2.this, KonecnyAutomat3.class));
                finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat2.this, KonecnyAutomat1.class));
                finish();
