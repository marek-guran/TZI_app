...
public class OperacieNadJazykmi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(OperacieNadJazykmi1.this, OperacieNadJazykmi2.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(OperacieNadJazykmi1.this, MainActivity.class));
        finish();
    }
}
