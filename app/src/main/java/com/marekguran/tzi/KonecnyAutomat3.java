...
public class KonecnyAutomat3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat3.this, MainActivity.class));
                finish();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat3.this, KonecnyAutomat4.class));
                finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KonecnyAutomat3.this, KonecnyAutomat2.class));
                finish();
