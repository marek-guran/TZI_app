...
class OperacieNadJazykmi3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi3, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi3, OperacieNadJazykmi4::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@OperacieNadJazykmi3, OperacieNadJazykmi2::class.java))
            finish()
        }
    }
