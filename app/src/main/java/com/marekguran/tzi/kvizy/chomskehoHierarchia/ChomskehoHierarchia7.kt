...
class ChomskehoHierarchia7 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chomskeho_hierarchia7)
        ...
        home.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia7, Kvizy::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia7, ChomskehoHierarchia8::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia7, ChomskehoHierarchia6::class.java))
            finish()
        }
    }
