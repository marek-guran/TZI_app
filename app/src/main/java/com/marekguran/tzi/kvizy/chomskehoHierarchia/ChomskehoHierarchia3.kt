...
class ChomskehoHierarchia3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chomskeho_hierarchia3)
        ...
        home.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia3, Kvizy::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia3, ChomskehoHierarchia4::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia3, ChomskehoHierarchia2::class.java))
            finish()
        }
    }
