...
class ChomskehoHierarchia2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chomskeho_hierarchia2)
        ...
        home.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia2, Kvizy::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia2, ChomskehoHierarchia3::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@ChomskehoHierarchia2, ChomskehoHierarchia1::class.java))
            finish()
        }
    }
