...
class AbecedaSlovoJazyk8 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk8, MainActivity::class.java))
            finish()
        }
        ...
        next.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk8, AbecedaSlovoJazyk9::class.java))
            finish()
        }
        back.setOnClickListener {
            startActivity(Intent(this@AbecedaSlovoJazyk8, AbecedaSlovoJazyk7::class.java))
            finish()
        }
    }
